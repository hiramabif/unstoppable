 ...
 * note: this is just a decoy. everything here checks out. payday is in the vault i guess. let's look at it.
 */
contract UnstoppableMonitor is Owned, IERC3156FlashBorrower {
        ...
        returns (bytes32)
    {
        ...
        } // this was the missing check in naive-receiver that made this exploit possible. note: in flashloans the initiator and msg.sender cannot and should not be blindly trusted.
